...
<h2 class="text-center">ข้อมูลของนักศึกษา</h2>
<div class="box">
    <form action="adminFile/action/student_edit.php" method="POST" class="row g-3 d-flex justify-content-center bg-white shadow mt-3 p-3">
        ...
        <div class="col-md-6">
            ...
            <input type="text" class="form-control" name="birthday" value="<?php echo $row['birthday'] ?>" disabled>
        </div>


        <div class="col-md-6">
            <label class="form-label">เชื้อชาติ</label>
            <input type="text" class="form-control" name="ethnicity" value="<?php echo $row['ethnicity'] ?>" disabled>
        </div>
        ...
        <div class="col-md-6">
            ...
            <input type="text" class="form-control" name="idcard" value="<?php echo $row['idcard'] ?>" disabled>
        </div>


        <div class="col-md-3">
                <label class="form-label">บ้านเลขที่</label>
                <input type="text" class="form-control" name="housenumber" placeholder="บ้านเลขที่" value="<?php echo $row['housenumber'] ?>" disabled>
            </div>

            
            <div class="col-md-3">
                <label class="form-label">หมู่</label>
                <input type="text" class="form-control" name="moo" placeholder="หมู่" value="<?php echo $row['moo'] ?>" disabled>
            </div>

            
            <div class="col-md-3">
                <label class="form-label">ตำบล</label>
                <input type="text" class="form-control" name="subdistrict" placeholder="ตำบล" value="<?php echo $row['subdistrict'] ?>"disabled >
            </div>

            
            <div class="col-md-3">
                <label class="form-label">ถนน</label>
                <input type="text" class="form-control" name="road" placeholder="ถนน" value="<?php echo $row['road'] ?>"disabled>
            </div>

            
            <div class="col-md-3">
                <label class="form-label">อำเภอ</label>
                <input type="text" class="form-control" name="district" placeholder="อำเภอ" value="<?php echo $row['district'] ?>" disabled>
            </div>

            
            <div class="col-md-3">
                <label class="form-label">จังหวัด</label>
                <input type="text" class="form-control" name="province" placeholder="จังหวัด" value="<?php echo $row['province'] ?>" disabled>
            </div>

            
            <div class="col-md-3">
                <label class="form-label">รหัสไปรษณีย์</label>
                <input type="text" class="form-control" name="postcode" placeholder="รหัสไปรษณีย์" value="<?php echo $row['postcode'] ?>" disabled>
            </div>
        ...
        <div class="col-md-6">
            ...
            <input type="text" class="form-control" name="studying" value="<?php echo $row['studying'] ?>" disabled>
        </div>
        ...
        <div class="col-md-6">
            ...
            <input type="text" class="form-control" name="schooladdress" value="<?php echo $row['schooladdress'] ?>" disabled>
        </div>

        <div class="col-md-6">
            <label class="form-label">สาขางาน/กรณีศึกษาอยู่ระดับชั้น ปวช.และปวส.</label>
            <input type="text" class="form-control" name="yoursaka" value="<?php echo $row['yoursaka'] ?>" disabled>
        </div>

        <div class="col-md-6">
            <label class="form-label">ผลงาน/รางวัลที่ได้รับ</label>
            <input type="text" class="form-control" name="workings" value="<?php echo $row['workings'] ?>" disabled>
        </div>

        <div class="col-md-6">
            <label class="form-label">ความสามารถพิเศษ</label>
            <input type="text" class="form-control" name="talent" value="<?php echo $row['talent'] ?>"disabled>
        </div>

        <div class="col-md-6">
            <label class="form-label">เกรดเฉลี่ยสะสม</label>
            <input type="text" class="form-control" name="gpa" value="<?php echo $row['gpa'] ?>"disabled>
        </div>

        <div class="col-md-6">
            <label class="form-label">มีความประสงค์ขอศึกษาต่อในระดับชั้น</label>
            <select class="form-select" id="vc" name="vcID" disabled>
        ...
        <div class="col-md-6">
            ...
            <input type="text" class="form-control" name="sakaname" value="<?php echo $row['sakaname'] ?>" disabled>
        </div>


        <div class="col-md-6">
            <label class="form-label">ปีการศึกษา</label>
            <input type="text" class="form-control" disabled value="<?php echo $row['year'] ?>" disabled>
        </div>
        ...
        <div class="col-md-12">
            ...
            <br>
            <img width="100" src="<?php echo "../upload_img/$row[idcard]/$row[qc_img]" ?>" disabled>
        </div>

        <div class="col-md-12">
            <label class="form-label">สำเนาบัตรประจำตัวประชาชน </label>
            <br>
            <img width="100" src="<?php echo "../upload_img/$row[idcard]/$row[idcard_img]" ?>" disabled>
        </div>

        <div class="col-md-12">
            <label class="form-label">สำเนาทะเบียนบ้าน</label>
            <br>
            <img width="100" src="<?php echo "../upload_img/$row[idcard]/$row[house_img]" ?>" disabled>
        </div>


        <div class="col-md-12">
            <center><a class="text-decoration-none btn btn-secondary text-white w-100 mt-2" href="user.php">ย้อนกลับ</a></center>
        </div>
