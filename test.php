...
$sql = "SELECT test.id,test.name,test.lastname,test.phone,test.age,test.birthday,test.ethnicity,test.sakaname
,test.nationality,test.religion,test.studying,test.schoolname,test.schooladdress,test.yoursaka,test.workings,test.talent,test.gpa,
test.housenumber,test.moo,test.subdistrict,test.road,test.district,test.province,test.postcode,test.idcard,vc.name AS vcname FROM test JOIN vc ON test.vcID = vc.id
WHERE test.id = 1";
