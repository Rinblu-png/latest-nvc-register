...
<body>
    ...
    <div class="main-container d-flex">
        <div class="sidebar bg-dark shadow" id="side_nav" >
            <div class="header-box px-2 pt-3 pb-4 d-flex justify-content-center mt-2">
                <h1 class="fs-4"><span class="bg-white text-dark  shadow p-2 head">User Dashboard</h1>
                <button class="btn d-md-none d-block close-btn px-1 py-0 text-white"><i class="fa-solid fa-backward"></i></button>
            </div>

            <ul class="list-unstyled px-2">
                <li class="<?php echo !isset($_GET['menu']) && empty($_GET['menu']) ? 'active' : '' ?>"><a href="user.php" class="text-decoration-none px-3 py-2 d-block"><i class="fa-solid fa-house"></i> หน้าแรก</a></li>
            ...
            <ul class="list-unstyled px-2">
                <li class="<?php echo isset($_GET['menu']) && $_GET['menu'] == "account" ? 'active' : '' ?>"><a href="user.php?menu=account" class="text-decoration-none px-3 py-2 d-block"><i class="fa-solid fa-user"></i> ตั้งค่าบัญชี</a></li>
